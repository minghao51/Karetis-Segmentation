...
get_eigenvalue<-factoextra::get_eigenvalue
conflict_prefer("set", "data.table")
...
# loading the data
oncology.profile.dt<-fread("OncologyProfile_simplified.csv")
