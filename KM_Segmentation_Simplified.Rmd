...
The rmd is meant to be used a introduction to ML segmentation based on document": **202002_ML training Segmentation.ppt**
...
# loading the data
# note that this assumes that the whole github repo is download with the original structure
...
**Defination**: Deconstructing the data into lesser dimension (for instance going from a 12-variable description to a 2D description) for synthetic comprehension and visualization.
...
# Hierarchy clustering - Clustering with different number of clusters, metrics and method
...
PCA is an analysis method that can be done with numerous methods - One of the more intuitive methods would be through eigen-decomposition. The whole process of obtaining principle components from a raw dataset can be simplified in 4 parts :
